      ...
      <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-purple-100 via-white to-orange-100 flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-[#044c5c] via-purple-600 to-orange-500 bg-clip-text text-transparent mb-6 leading-tight">
            Kendini Test Et,
            <br />
            <span className="text-4xl sm:text-5xl lg:text-6xl bg-gradient-to-r from-pink-500 via-[#21817c] to-blue-600 bg-clip-text text-transparent">Öğrenmeye Devam Et!</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-[#2d6c74] mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
            QuizPortal ile bilgini sınayabilir, gelişimini takip edebilir ve kendine 
            <span className="text-[#044c5c] font-semibold"> meydan okuyabilirsin.</span>
          </p>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1200 120" className="w-full h-20 fill-purple-500/20">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-indigo-50 to-rose-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-[#044c5c] mb-16">
            Neden <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">QuizPortal?</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-purple-200 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-[#044c5c] mb-4">Öğrenme Odaklı</h3>
              <p className="text-[#37747c] leading-relaxed">Her quiz sonrasında detaylı açıklamalar ve doğru cevaplar ile bilgini pekiştir.</p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-orange-200 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-[#044c5c] mb-4">İlerleme Takibi</h3>
              <p className="text-[#37747c] leading-relaxed">Performansını izle, güçlü ve zayıf alanlarını keşfet, gelişimini gözlemle.</p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-blue-200 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-[#044c5c] mb-4">Rekabet Ruhu</h3>
              <p className="text-[#37747c] leading-relaxed">Diğer kullanıcılarla yarış, liderlik tablolarında yerini al ve başarılarını sergile.</p>
            </div>
          </div>
        </div>
      </section>
